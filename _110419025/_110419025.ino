...
void buildWeb(){
  ...
  webSite += "<style>";
  webSite += "body{background-color:#FFFFFF; font-family: Arial, Helvetica, Sans-Serif; Color: #000088;}";
...
void handleLEDStatus(){
  if(server.arg("led") == "red"){
     led_status = "<style>body{background-color:red;} p{color:white; font-size:72px;}</style> <p>RED</p>";
     //snprintf(led_status,"Now, RGB LED color is red...");     
    ...
    led_status = "<style>body{background-color:green;} p{color:white; font-size:72px;}</style> <p>GREEN</p>";
     //snprintf(led_status,"Now, RGB LED color is green...");
    digitalWrite(LEDR,LOW);
    digitalWrite(LEDG,HIGH);
    digitalWrite(LEDB,LOW);
  }
  else if(server.arg("led") == "blue"){
    led_status = "<style>body{background-color:blue;} p{color:white; font-size:72px;}</style> <p>BLUE</p>";
    // snprintf(led_status,"Now, RGB LED color is blue...");
    digitalWrite(LEDR,LOW);
    digitalWrite(LEDG,LOW);
